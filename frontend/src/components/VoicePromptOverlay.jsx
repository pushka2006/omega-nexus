  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 10.5, color: "rgba(148, 163, 184, 0.55)", fontFamily: "monospace", textAlign: "center", lineHeight: 1.5, marginBottom: 12 }}>
          Speak clearly: <span style={{ color: "#00F5FF" }}>"open youtube"</span>, <span style={{ color: "#00F5FF" }}>"open github"</span>, <span style={{ color: "#00F5FF" }}>"open google"</span>, <span style={{ color: "#00F5FF" }}>"open facebook"</span>, or <span style={{ color: "#00F5FF" }}>"open amazon"</span>.
        </p>
        ...
        <div style={{ display: "flex", gap: 6, flexWrap: "wrap", justifyContent: "center", marginBottom: 16 }}>
          {[
            ...
            { label: "🌐 Facebook", cmd: "open facebook" },
            { label: "🛒 Amazon", cmd: "open amazon" },
          ].map((chip) => (
            <button
              key={chip.cmd}
              onClick={() => {
                executeVoiceCommand(chip.cmd);
                stopListening();
              }}
              style={{
                ...
                color: "#00F5FF", fontSize: 9.5, fontFamily: "monospace",
